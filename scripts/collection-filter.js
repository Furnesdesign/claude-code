...
(function() {
   ...
   function setupMutationObserver() {
      ...
      var debouncedRefresh = debounce(refreshItems, 200);
   ...
   // Finsweet CMS Load integration - primary initialization
   window.fsAttributes = window.fsAttributes || [];
    window.fsAttributes.push([
          ...
          (listInstances) => {
                  ...
                  // Initialize after Finsweet is ready
            init();
          },
        ]);

   // Fallback: if Finsweet doesn't load within 3 seconds, init anyway
   setTimeout(() => {
